...
if __name__ == '__main__':
    ...
    ds_train_representations = MNISTMetricDataset(mnist_download_root, split='train')
    ...
    representations_loader = DataLoader(
        ds_train_representations,
        batch_size=64,
        shuffle=True,
        pin_memory=True,
        num_workers=4,
    ...
    for epoch in range(epochs):
        ...
        if EVAL_ON_TEST or EVAL_ON_TRAIN:
            ...
            representations = compute_representations(model, representations_loader, num_classes, emb_size, device)
        if EVAL_ON_TRAIN:
    ...
    torch.save(model.state_dict(), './model_metric_zero_shot.pt')
